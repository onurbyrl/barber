...
class Appointment(models.Model):
    ...
    full_name = models.CharField(max_length=30, null=False, blank=False, default='customer')
    phone = models.CharField(max_length=20, null=False, blank=False, default='12346')
    date_time = models.DateTimeField(unique=False, null=True, blank=True)
