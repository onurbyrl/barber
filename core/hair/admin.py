...
from .models import About, AboutImages, Address, Contact, Gallery, Hours, MotionPicture, ServicesLeft, ServicesRight, ServicesText, Videos
...
class AddressAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Konum', {
            'fields': ('location',),
            'description': 'Write the location info',
        }),
    )
